...
def calculo_antiguedad():
    ...
    print("dia de egreso: ", dia_extincion)
    print("mes de egreso: ", mes_extincion)
    print("anio de egreso: ", año_extincion)

    años = diferencia.years
    meses = diferencia.months
    dias = diferencia.days
    
    print("los numeros de a anios son: ", años)
    print("los numeros de a meses son: ",meses)
    print("los numeros de a dias son: ",dias)
...
def calculo_indemnizacion_preaviso():
    global indemnizacion_preaviso
    salario_promedio = float(cuadrotexto3.get())

    print("ninguna de las anteriores")
    if años >= 5:
        indemnizacion_preaviso = salario_promedio * 2
    elif años < 5 and meses >= 3:
        indemnizacion_preaviso = salario_promedio
    elif años == 0 and meses < 3:
        indemnizacion_preaviso = salario_promedio/2
    else:
        print("ninguna de las anteriores")

    if var_preaviso.get() == 1:
        texto_indemnizacion_preaviso.config(text= "$ " + str(indemnizacion_preaviso))
    else:
...
def calculo_SAC_preaviso():
    ...
    SAC_preaviso = indemnizacion_preaviso / 12
...
"""def doble_indemnizacion():
    global monto_doble_indemnizacion
    
    if day_1 < 13 and month_1 == 12 and year_1 == 2019 and indemnizacion_por_antiguedad + indemnizacion_preaviso + SAC_preaviso + integracion_mes_despido + SAC_integracion > 500000:
        monto_doble_indemnizacion = 500000

    elif day_1 < 13 and month_1 == 12 and year_1 == 2019 and indemnizacion_por_antiguedad + indemnizacion_preaviso + SAC_preaviso + integracion_mes_despido + SAC_integracion < 500000:
        doble_indemnizacion = indemnizacion_por_antiguedad + indemnizacion_preaviso + SAC_preaviso + integracion_mes_despido + SAC_integracion

    elif year_1 == 2019 and month_1 < 12 and indemnizacion_por_antiguedad + indemnizacion_preaviso + SAC_preaviso + integracion_mes_despido + SAC_integracion > 500000:
        monto_doble_indemnizacion = 500000

    elif year_1 == 2019 and month_1 < 12 and indemnizacion_por_antiguedad + indemnizacion_preaviso + SAC_preaviso + integracion_mes_despido + SAC_integracion < 500000:
        monto_doble_indemnizacion = indemnizacion_por_antiguedad + indemnizacion_preaviso + SAC_preaviso + integracion_mes_despido + SAC_integracion

    elif year_1 < 2019 and indemnizacion_por_antiguedad + indemnizacion_preaviso + SAC_preaviso + integracion_mes_despido + SAC_integracion > 500000:
        monto_doble_indemnizacion = 500000
        ...
        monto_doble_indemnizacion = 0

    if var_doble_indemnizacion.get() == 1:
        texto_doble_indemnizacion.config(text= "$ " + str(monto_doble_indemnizacion))
    else:
        texto_doble_indemnizacion.config(text= "")
"""
# ------------------------------------- Menu -----------------------------------
...
boton1 = Button(miFrame, text="Ejecutar liquidación", command = lambda: [calculo_antiguedad(), calculo_indemnizacion_antiguedad(), calculo_indemnizacion_preaviso(), calculo_SAC_preaviso(), calculo_integracion(),calculo_SAC_integracion()]) #, doble_indemnizacion()]) 
